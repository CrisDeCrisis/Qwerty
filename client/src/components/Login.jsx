                    ...
                    <MDBCol col='12'>
                        <MDBCard id='login-card' className='bg-white text-dark my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '400px' }}>
                            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
                                ...
                                <div>
                                    <p className="mb-0">No tienes una cuenta? <Link to={'/register'} className="text-dark-50 fw-bold" style={{ textDecoration: 'none', color: 'rgba(255, 0, 0, 0.685)' }}>Registrate</Link></p>
                                </div>
                            </MDBCardBody>
                        </MDBCard>
                    </MDBCol>
